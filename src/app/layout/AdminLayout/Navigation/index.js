...
const mapStateToProps = (state) => {
  return {
    ...
    preLayout: state.layouts.preLayout,
    collapseMenu: state.layouts.collapseMenu,
    layoutType: state.layouts.layoutType,
    navBackColor: state.layouts.navBackColor,
    navBackImage: state.layouts.navBackImage,
    navIconColor: state.layouts.navIconColor,
    navBrandColor: state.layouts.navBrandColor,
    layout6Background: state.layouts.layout6Background,
    layout6BackSize: state.layouts.layout6BackSize,
    rtlLayout: state.layouts.rtlLayout,
    navFixedLayout: state.layouts.navFixedLayout,
    boxLayout: state.layouts.boxLayout,
    navDropdownIcon: state.layouts.navDropdownIcon,
    navListIcon: state.layouts.navListIcon,
    navActiveListColor: state.layouts.navActiveListColor,
    navListTitleColor: state.layouts.navListTitleColor,
    navListTitleHide: state.layouts.navListTitleHide,
  };
};
